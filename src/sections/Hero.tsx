...
export const Hero = () => {
  return (
    <section className="pt-8 pb-20 md_pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip">
          ...
          <div className='md:w-[478px]'>
            <div>
              ...
              <p className="text-xl text-[#010D3E] tracking-tight mt-6">
                Celebrate the joy of accomplishment with an app designed to train your progress,
