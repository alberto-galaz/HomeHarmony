    ...
    <header className='sticky top-0'>
      <div className="flex justify-center items-center py-3 bg-black text-white text-small gap-3"> 
        <p className='text-white/60 hidden md:block'>
         Streamline your workflow and boost producticity
        </p>
        <div className="inline-flex gap-10 items-center"></div>
        <p>Get Started for free</p>
        <ArrowRight className= "h-4 2-4 inline-flex justify-center items-center"/>
      </div>
      <div className='py-5'>
